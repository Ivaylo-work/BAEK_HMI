...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        ...
        (function (BAUK_EK_BMS_HMI) {
            function TennisTableHandler(ControlName) {
            ...
            BAUK_EK_BMS_HMI.TennisTableHandler = TennisTableHandler;
        })(BAUK_EK_BMS_HMI = Functions.BAUK_EK_BMS_HMI || (Functions.BAUK_EK_BMS_HMI = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx('TennisTableHandler', 'TcHmi.Functions.BAUK_EK_BMS_HMI', TcHmi.Functions.BAUK_EK_BMS_HMI.TennisTableHandler);
