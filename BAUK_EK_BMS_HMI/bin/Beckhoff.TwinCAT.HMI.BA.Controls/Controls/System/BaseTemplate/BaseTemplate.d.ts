declare module TcHmi.BuildingAutomation.Controls.System {
    ...
    */
    class BaseTemplate<T extends BA.BaView.BaTemplateStructure> extends TcHmi.Controls.System.TcHmiControl implements Components.Base.IBase, Components.ResizeHandler.IOnResized, Logger.ILogger, IEventHandler, BA.IBaTemplateHandler<T>, BaObjectHandler.IFCUsesBaObject {
        ...
        */
        ...
        logger: Logger;
        eventHandler: EventHandler<BaseTemplate<T>>;
