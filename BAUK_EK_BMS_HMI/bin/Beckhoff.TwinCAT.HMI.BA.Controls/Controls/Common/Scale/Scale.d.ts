declare module TcHmi.BuildingAutomation.Controls.Common {
     ...
     * @category Control
    */
    class Scale extends System.BaseControl implements Components.ResizeHandler.IOnResized, BaObjectHandler.IFCUsesBaObject, IEventHandler {
        constructor(element: JQuery, pcElement: JQuery, attrs: TcHmi.Controls.ControlAttributeList);
        baObjectHandler: BaObjectHandler;
        resizeHandler: Components.ResizeHandler;
        eventHandler: EventHandler<Scale>;
    ...
    module Scale {
         ...
         * @category Scale
         */
        class Setpoint extends Components.Base implements IEventHandler {
            constructor(id: string, parent: Components.Base.IBase | null);
            eventHandler: EventHandler<Setpoint>;
            private __value;
