declare module TcHmi.BuildingAutomation.Controls.Common {
    ...
    */
    class Combobox<T> extends System.TextControl implements BaInterfaceHandler.IUsesBaInterface<Combobox.BaInterface<T>>, BaObjectHandler.IFCUsesBaObject, IEventHandler {
        ...
        getBaInterfaceSymbolNames(): BaInterfaceHandler.BaInterfaceSymbolNames<Combobox.BaInterface<T>> | null | undefined;
        /**
