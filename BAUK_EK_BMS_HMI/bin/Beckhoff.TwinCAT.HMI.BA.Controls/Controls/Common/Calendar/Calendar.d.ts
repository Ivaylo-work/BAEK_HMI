declare module TcHmi.BuildingAutomation.Controls.Common {
    ...
    class Calendar extends System.BaseControl implements BaObjectHandler.IFCUsesBaObject {
        ...
        /**
         * Get BA Exception Schedule entries within given date range.
         * @category Public
         */
        getSchedExceptionEntries(source?: Components.Calendar.CalendarEventSource, begin?: Date, end?: Date): BA.SchedExceptionList | null;
        /**
