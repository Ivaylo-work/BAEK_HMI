declare module TcHmi.BuildingAutomation.Controls.Common {
    ...
    */
    class InputBox<T extends string | number> extends System.TextControl implements BaInterfaceHandler.IUsesBaInterface<InputBox.BaInterface<T>>, BaObjectHandler.IFCUsesBaObject, IEventHandler {
        ...
        getBaInterfaceSymbolNames(): BaInterfaceHandler.BaInterfaceSymbolNames<InputBox.BaInterface<T>> | null | undefined;
        /**
