declare module TcHmi.BuildingAutomation.Controls.BuildingGeneral {
     ...
     * @category Control
    */
    class BuildingInformation extends Common.Button implements IEventHandler {
        constructor(element: JQuery, pcElement: JQuery, attrs: TcHmi.Controls.ControlAttributeList);
        protected __attrHandler: AttributeHandler<BuildingInformation.IAttributes>;
        eventHandler: EventHandler<BuildingInformation>;
        ...
        static getIcon(alarm: BuildingInformation.Alarms): Icons.IconData;
